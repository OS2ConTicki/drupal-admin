...
namespace Drupal\os2conticki_content\Element;
...
class ConferenceEntityAutocomplete extends EntityAutocomplete {
  ...
  public static function processEntityAutocomplete(
    ...
    $conference = $form_state->get(['os2conticki_content', 'conference']);

    if (NULL !== $conference) {
      $element['#autocomplete_route_name'] = 'os2conticki_content.conference_entity_autocomplete';
